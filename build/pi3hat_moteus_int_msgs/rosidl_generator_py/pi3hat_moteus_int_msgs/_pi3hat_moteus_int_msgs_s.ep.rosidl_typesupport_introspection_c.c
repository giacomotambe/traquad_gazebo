...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "pi3hat_moteus_int_msgs/msg/detail/omni_mulinex_command__type_support.h"
...
static void * pi3hat_moteus_int_msgs__msg__omni_mulinex_command__create_ros_message(void)
{
  return pi3hat_moteus_int_msgs__msg__OmniMulinexCommand__create();
}

static void pi3hat_moteus_int_msgs__msg__omni_mulinex_command__destroy_ros_message(void * raw_ros_message)
{
  pi3hat_moteus_int_msgs__msg__OmniMulinexCommand * ros_message = (pi3hat_moteus_int_msgs__msg__OmniMulinexCommand *)raw_ros_message;
  pi3hat_moteus_int_msgs__msg__OmniMulinexCommand__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool pi3hat_moteus_int_msgs__msg__omni_mulinex_command__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * pi3hat_moteus_int_msgs__msg__omni_mulinex_command__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(pi3hat_moteus_int_msgs, msg, OmniMulinexCommand);

int8_t
_register_msg_type__msg__omni_mulinex_command(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__omni_mulinex_command__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__omni_mulinex_command",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__omni_mulinex_command__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__omni_mulinex_command",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__omni_mulinex_command__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__omni_mulinex_command",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__omni_mulinex_command__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__omni_mulinex_command",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(pi3hat_moteus_int_msgs, msg, OmniMulinexCommand),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__omni_mulinex_command",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "pi3hat_moteus_int_msgs/msg/detail/quad_foot_state__type_support.h"
...
static void * pi3hat_moteus_int_msgs__msg__quad_foot_state__create_ros_message(void)
{
  return pi3hat_moteus_int_msgs__msg__QuadFootState__create();
}

static void pi3hat_moteus_int_msgs__msg__quad_foot_state__destroy_ros_message(void * raw_ros_message)
{
  pi3hat_moteus_int_msgs__msg__QuadFootState * ros_message = (pi3hat_moteus_int_msgs__msg__QuadFootState *)raw_ros_message;
  pi3hat_moteus_int_msgs__msg__QuadFootState__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool pi3hat_moteus_int_msgs__msg__quad_foot_state__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(pi3hat_moteus_int_msgs, msg, QuadFootState);

int8_t
_register_msg_type__msg__quad_foot_state(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__quad_foot_state__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__quad_foot_state",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__quad_foot_state__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__quad_foot_state",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__quad_foot_state__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__quad_foot_state",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&pi3hat_moteus_int_msgs__msg__quad_foot_state__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__quad_foot_state",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(pi3hat_moteus_int_msgs, msg, QuadFootState),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__quad_foot_state",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
PyMODINIT_FUNC
PyInit_pi3hat_moteus_int_msgs_s__rosidl_typesupport_introspection_c(void)
{
  ...
  err = _register_msg_type__msg__omni_mulinex_command(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }

  err = _register_msg_type__msg__quad_foot_state(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
