...
void fetch_function__PacketPass__name(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__PacketPass__name(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__PacketPass__name(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__PacketPass__name(untyped_member, index));
...
void fetch_function__PacketPass__pack_loss(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__PacketPass__pack_loss(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__PacketPass__pack_loss(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__PacketPass__pack_loss(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PacketPass_message_member_array[6] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pi3hat_moteus_int_msgs::msg::PacketPass, write2read_dur),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    fetch_function__PacketPass__name,  // fetch(index, &value) function pointer
    assign_function__PacketPass__name,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__PacketPass__pack_loss,  // fetch(index, &value) function pointer
    assign_function__PacketPass__pack_loss,  // assign(index, value) function pointer
