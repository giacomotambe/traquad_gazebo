...
static rosidl_typesupport_introspection_c__MessageMember pi3hat_moteus_int_msgs__msg__PacketPass__rosidl_typesupport_introspection_c__PacketPass_message_member_array[6] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pi3hat_moteus_int_msgs__msg__PacketPass, write2read_dur),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
