...
struct PacketPass_
{
  ...
  using _write2read_dur_type =
    double;
  _write2read_dur_type write2read_dur;
  using _name_type =
  ...
  Type & set__write2read_dur(
    const double & _arg)
  {
    this->write2read_dur = _arg;
    return *this;
  }
  Type & set__name(
  ...
  bool operator==(const PacketPass_ & other) const
  {
    ...
    if (this->write2read_dur != other.write2read_dur) {
      return false;
    }
