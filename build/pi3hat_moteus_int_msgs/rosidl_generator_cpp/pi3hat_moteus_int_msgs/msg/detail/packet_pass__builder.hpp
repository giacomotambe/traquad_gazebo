...
class Init_PacketPass_write2read_dur
{
public:
  explicit Init_PacketPass_write2read_dur(::pi3hat_moteus_int_msgs::msg::PacketPass & msg)
  : msg_(msg)
  {}
  Init_PacketPass_name write2read_dur(::pi3hat_moteus_int_msgs::msg::PacketPass::_write2read_dur_type arg)
  {
    msg_.write2read_dur = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_PacketPass_write2read_dur cycle_dur(::pi3hat_moteus_int_msgs::msg::PacketPass::_cycle_dur_type arg)
  {
    msg_.cycle_dur = std::move(arg);
    return Init_PacketPass_write2read_dur(msg_);
  }
