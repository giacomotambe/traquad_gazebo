...
#include "custom_interfaces/msg/detail/wheel_velocity_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
max_serialized_size_WheelVelocityCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::WheelVelocityCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::WheelVelocityCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WheelVelocityCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::WheelVelocityCommand *>(
...
static size_t _WheelVelocityCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WheelVelocityCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WheelVelocityCommand__callbacks = {
...
static rosidl_message_type_support_t _WheelVelocityCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WheelVelocityCommand__callbacks,
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_WheelVelocityCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, WheelVelocityCommand)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_WheelVelocityCommand__handle;
}
